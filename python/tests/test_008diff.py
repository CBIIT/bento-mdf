...
class TestDiffs:
    ...
    def test_diff_of_same_yaml(self):
        ...
        actual = diff_models(
            TEST_MODEL_A.model, TEST_MODEL_A.model, objects_as_dicts=True
        )
        expected = {}
    ...
    def test_diff_of_extra_node_properties_and_terms(self):
        """a_b"""
        actual = diff_models(
            TEST_MODEL_A.model, TEST_MODEL_B.model, objects_as_dicts=True
        )
    ...
    def test_diff_of_extra_node_property(self):
        """a_d"""
        actual = diff_models(
            TEST_MODEL_A.model, TEST_MODEL_D.model, objects_as_dicts=True
        )
        expected = {
            "nodes": {
                "changed": {
    ...
    def test_diff_of_extra_node_edge_and_property(self):
        """a_e"""
        actual = diff_models(
            TEST_MODEL_A.model, TEST_MODEL_E.model, objects_as_dicts=True
        )
        expected = {
            "nodes": {
                "removed": None,
    ...
    def test_diff_of_extra_node(self):
        """a_f"""
        actual = diff_models(
            TEST_MODEL_A.model, TEST_MODEL_F.model, objects_as_dicts=True
        )
        expected = {
            "nodes": {
    ...
    def test_diff_of_missing_node(self):
        """a_g"""
        actual = diff_models(
            TEST_MODEL_A.model, TEST_MODEL_G.model, objects_as_dicts=True
        )
        expected = {
            "nodes": {
                "removed": None,
    ...
    def test_diff_of_swapped_nodeprops(self):
        """a_h"""
        actual = diff_models(
            TEST_MODEL_A.model, TEST_MODEL_H.model, objects_as_dicts=True
        )
        expected = {
            "nodes": {
                "changed": {
    ...
    def test_diff_where_yaml_has_extra_term(self):
        """c_d"""
        actual = diff_models(
            TEST_MODEL_C.model, TEST_MODEL_D.model, objects_as_dicts=True
        )
        expected = {
            "props": {
                "changed": {
                    ("diagnosis", "fatal"): {
                        "value_set": {
                            "removed": None,
                            "added": {
                                "unknown": {"value": "unknown", "origin_name": "test"}
                            },
                        }
                    }
                },
    ...
    def test_diff_of_assorted_changes(self):
        """d_e"""
        actual = diff_models(
            TEST_MODEL_D.model, TEST_MODEL_E.model, objects_as_dicts=True
        )
        expected = {
            "nodes": {
                "changed": {
...
class TestDiffSummaries:
    ...
    def test_diff_of_assorted_changes_summary(self):
        """d_e summary only"""
        actual = diff_models(
            TEST_MODEL_D.model,
            TEST_MODEL_E.model,
...
class TestValueSets:
    """group tests for value_sets_are_different method"""
    ...
    def test_identical_value_sets_are_not_different(self):
        """Test value_sets_are_different returns False for value sets with same terms"""
    ...
    def test_value_set_with_removed_term_is_different(self):
        """Test value_sets_are_different returns True when first value_set has extra term"""
    ...
    def test_value_set_with_added_term_is_different(self):
        """Test value_sets_are_different returns True when second value_set has extra term"""
    ...
    def test_empty_value_sets_are_not_different(self):
        """Test value_sets_are_different returns False for empty value sets"""
    ...
    def test_value_set_not_different_from_self(self):
        """Test value_sets_are_different returns False when value set compared to itself"""
    ...
    def test_identical_prop_value_sets_are_not_different(self):
        """Test value_sets_are_different returns False for properties with identical value sets"""
